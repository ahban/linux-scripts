...
func SetTitle()
    ...
    elseif 'tex' == &filetype || 'plaintex' == &filetype
        ...
        call append(line(".")+ 7, "\\usepackage{abanArt}")
        call append(line(".")+ 8, "\\title{文档题目}")
        call append(line(".")+ 9, "\\author{班志华 \\\\ \\href{mailto:sawpara@126.com}{sawpara@126.com}}")
        call append(line(".")+10, "\\date{\\today}")
        call append(line(".")+11, "\\begin{document}")
        call append(line(".")+12, "\\maketitle")
